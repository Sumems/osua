        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Tambah Hiking Trail</h5>
                ...
                <form role="form" id="form" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group has-error">
                                    ...
                                    <input autocomplete="off" class="form-control" type="text" name="name"
                                        value="" placeholder="Masukan Nama Gunung" required>
                                    <span class="has-error help-block"></span>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group has-error">
                                    <label class="form-control-label">Titik Kordinat Latitude <span
                                            style="color: red">*</span></label>
                                    <input autocomplete="off" class="form-control" type="number" step="0.000001"
                                        name="latitude" value="" placeholder="Masukan Titik Kordinat Latitude"
                                        required
                            ...
                            <div class="col-lg-6">
                                <div class="form-group has-error">
                                    <label class="form-control-label">Titik Koordinat Longitude <span
                                            style="color: red">*</span></label>
                                    <input autocomplete="off" class="form-control" type="number" step="0.000001"
                                        name="longitude" value="" placeholder="Masukan Titik Koordinat Longitude"
                                        required
                                        style="-webkit-appearance: none; -moz-appearance: textfield; appearance: none;">
                                    <span class="has-error help-block"></span>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#tableHikingTrail').on('click', '.edit-modal', function() {
                ...
                $('#exampleModalLabel').text('Edit Hiking Trail');
                $('#btn-save').data('action', 'edit').text('Update');
                $('#metode').val('edit');
                $('#id').val(data.id);
                $('input[name="name"]').val(data.name.replace('_', ' '));
